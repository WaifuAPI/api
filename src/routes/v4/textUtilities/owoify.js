...
import getOwoifyText from '../../../controllers/v4/textUtilities/owoify.js';
...
router
  .route('/')
  /**
   * @api {get} v4/owoify Owoify Text
   * @apiDescription Transform user input normal text into owoified text.
   * @apiName owoifyText
   ...
   *
   */
  .get(authorize(config.roles.USER), createRateLimiter(), getOwoifyText);
