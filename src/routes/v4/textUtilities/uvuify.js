...
import getUvuifyText from '../../../controllers/v4/textUtilities/uvuify.js';
...
router
  .route('/')
  /**
   * @api {get} v4/uvuify Uvuify Text
   * @apiDescription Transform user input normal text into uvuified text.
   * @apiName uvuifyText
   ...
   *
   */
  .get(authorize(config.roles.USER), createRateLimiter(), getUvuifyText);
